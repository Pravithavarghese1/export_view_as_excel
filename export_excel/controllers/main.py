...
#
##############################################################################
from gtk._gtk import Orientable, Orientation
...
from odoo.report.render.rml2pdf import trml2pdf
import time, os
import locale
...
class PvExcelExport(ExcelExport):
    _cp_path = '/web/export/pv_excel_export'
...
#                         cellvalue = float(cellvalue)
        ...
        fp.close()
        return data
    @http.route('/web/export/pv_excel_export', type='http', auth="user")
...
class PvPdfExport(ExportPdf):
    _cp_path = '/web/export/pv_pdf_export'
    
    @http.route('/web/export/pv_pdf_export', type='http', auth="user")
    def index(self, data, token):
        data = json.loads(data)
